...
import 'RootAdminDashboardPage.dart';

class RootAdminProfilePage extends StatelessWidget {
  const RootAdminProfilePage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    if (currentUser == null) {
      return const Scaffold(
        body: Center(child: Text("Root Admin not logged in")),
      );
    }

    return Scaffold(
      appBar: AppBar(
        title: const Text('Root Admin Profile'),
        ...
        child: StreamBuilder<DocumentSnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            if (!snapshot.hasData || !snapshot.data!.exists) {
              return Center(
                child: Text(
                  "Root admin profile not found for UID: ${currentUser.uid}",
